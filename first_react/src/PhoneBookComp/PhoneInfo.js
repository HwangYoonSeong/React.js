        ...
        if (editing) { // 수정모드
            return (
                <div style={style}>
                    ...
                    <button style={modifyStyle} onClick={this.handleToggleEdit}>MODIFY</button>
                    <button style={deletStyle} onClick={this.handleRemove}>DELETE</button>
                </div>
            );
        }
